                ...
                <div class="header">
                    <div class="head-nav">
                        ...
                        <ul class="cl-effect-1">
                            ...
                            <li class ="active"><a href="viewExperts.php">View Experts</a></li>
...
<?php
		...
		mysqli_select_db($db_con, $DB_NAME);
			...
			while($rows = mysqli_fetch_assoc($result)) {
						...
						echo '<tr>';
						echo "<td><font color ='green'>".$rows["name"]."</font></td>"."<td><font color ='green'>". $rows["desg"]."</td></td>"."<td><font color ='green'>".$rows["mobile"]."</font></td>"."<td><font color ='green'>".$rows["email"]."</font></td>"."<td><font color ='green'><a href = DeleteExpertFromAdmin.php?email=".$rows["email"].">Delete</a></font></td>";
						echo '</tr>';
